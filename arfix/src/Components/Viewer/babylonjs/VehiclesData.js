...
export class CarFromBoxesData extends VehicleData{
    constructor(scene){
        ...
        this.wings = makebox(scene, new BABYLON.Vector3(4, 0.5, 0.2), new BABYLON.Vector3(0, 1, 1), new BABYLON.Vector3(0,0,0).toQuaternion())
        this.chassisMesh.addChild(this.wings);
        this.createPhysicsImpostor(this.scene, this.wings, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0.1}, true);
        //this.chassisMesh.addChild(this.wings);
        //wings.physicsImpostor.parent = this.chassisMesh.physicsImpostor;

        this.createPhysicsImpostor(this.scene, this.chassisMesh, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 200, friction: 0.5}, true);
...
export class ThreeWheelAirplane extends VehicleData{
    ...
    constructor(scene, meshAll){
        ...
        colidersBox.forEach(m=>this.createPhysicsImpostor(this.scene, m, BABYLON.PhysicsImpostor.BoxImpostor, { mass: 0, friction: 0.1}, true));
        colidersSphere.forEach(m=>this.createPhysicsImpostor(this.scene, m, BABYLON.PhysicsImpostor.CapsuleImpostor, { mass: 0, friction: 0}, true));
        this.createPhysicsImpostor(this.scene, meshAll[11], BABYLON.PhysicsImpostor.BoxImpostor, { mass: 30, friction: 1}, true);
